...
> **Windows Script Host Monitor** - Monitors wscript.exe and cscript.exe execution.

---

## 📋 Overview

ScriptHostDetection monitors Windows Script Host (WSH) execution including wscript.exe and cscript.exe to detect malicious script execution.

---

## 🎯 What It Detects

- 📜 **WSH Execution** - wscript/cscript usage
- 📝 **Script Abuse** - Malicious scripts
- 🎭 **Obfuscated Scripts** - Hidden payloads
- 🔗 **Remote Scripts** - Network-hosted scripts
